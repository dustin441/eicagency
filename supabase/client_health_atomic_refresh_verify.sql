...
declare
  ...
  v_revision_id uuid := '2ee9145b-aa03-8201-99d1-54af04e8a32f';
  v_revision_hash text := '2ee9145baa03d20119d154af04e8a32f6dd9d6828ca32f3b79cbef5f28719b96';
  ...
  v_later_revision_id uuid := 'e95e9614-aba6-8037-93f5-354e997ce1b8';
  v_later_revision_hash text := 'e95e9614aba66037d3f5354e997ce1b8e9862377c5899ee4aa6e37f7ea853e92';
...
begin
  ...
  perform public.client_health_complete_source_run(v_source,v_run,'succeeded',v_base+interval '1 second',date '2026-08-20',1,repeat('b',64),'{}'::jsonb,null,null,v_invocation,v_attempt,1);
  ...
  foreach v_proc in array array['public.client_health_assert_exact_keys(jsonb,text[],text)'::regprocedure,'public.client_health_canonical_json(jsonb)'::regprocedure,'public.client_health_assert_owned_lease(uuid,uuid,uuid,bigint)'::regprocedure,'public.client_health_assert_run_provenance(uuid)'::regprocedure] loop
