...
function metadataString(post: EicContentPost, key: string) { const value = post.metadata?.[key]; return typeof value === 'string' ? value : ''; }
function previewImageUrl(post: EicContentPost) { return metadataString(post, 'thumbnail_url') || metadataString(post, 'image_url') || (post.asset_url && /\.(png|jpe?g|webp|gif)(\?|$)/i.test(post.asset_url) ? post.asset_url : ''); }
