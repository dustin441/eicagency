...
// Inline AI Creative Insight card for clients that surface the vision-workflow
// output on their Performance tab (above the Ad Performance / Meta Ad Creatives
// table). Mirrors Spartaco's BrandAiInsightCard so the look stays consistent.
