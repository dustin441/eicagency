...
function TrendChart({ timeSeries }: { timeSeries: DurodyneDashboardData['timeSeries'] }) {
...
function ChannelBreakdown({ channelRows }: { channelRows: DurodyneDashboardData['channelRows'] }) {
...
function WeeklyNotes({ readout }: { readout: DurodyneDashboardData['weeklyReadout'] }) {
...
export default function DurodyneDashboardClient({
  data,
  isAdmin,
  updateBudget,
}: {
    ...
    <div className="min-h-screen bg-gray-50/50">
      ...
      <div className="bg-white border-b border-gray-100 px-6 py-5">
        <div className="max-w-7xl mx-auto flex flex-col gap-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-xl font-bold text-gray-900">Duro Dyne</h1>
      ...
      <div className="max-w-7xl mx-auto px-6 py-6 space-y-6">
        ...
        <MetaAdPreviews
          ...
          description="Meta ad-level creative performance for Duro Dyne"
