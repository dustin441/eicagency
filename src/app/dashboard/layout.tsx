...
const CLIENTS = [
  ...
  },
  {
    ...
    defaultHref: '/dashboard/state-forty-eight',
    links: [
      { name: 'Performance', href: '/dashboard/state-forty-eight', icon: BarChart2 },
    ],
  },
  {
    id: 'cba',
  ...
  {
    id: 'ihh',
    name: 'InfiniteHeart Health',
    defaultHref: '/dashboard/ihh',
    links: [
      { name: 'Performance', href: '/dashboard/ihh', icon: BarChart2 },
...
type DashboardContext = ClientId;
...
function detectClientFromPath(pathname: string): DashboardContext | null {
  ...
  if (pathname.startsWith('/dashboard/state-forty-eight')) return 'state48';
