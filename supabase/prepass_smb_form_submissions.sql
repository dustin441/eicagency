-- PrePass SMB Mobile-App landing-page submissions.
--
-- This is additive to the existing SMB pipeline. Existing native Lead Ads and
-- Google/Meta MQL, SQL and WON logic remains unchanged. The RPC returns only
-- contact-deduplicated LP adjustments, split by date and platform so dashboard
-- totals and breakdowns reconcile.
